...
public class InteractableEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(enableGoTo, new GUIContent("Walk to the object"));
        ...
        EditorGUILayout.PropertyField(enableLookAt, new GUIContent("Look at object"));

        if (interactable.enableLookAt)
        {
            if (objectToLookAt.objectReferenceValue == null) objectToLookAt.objectReferenceValue = interactable.transform;
